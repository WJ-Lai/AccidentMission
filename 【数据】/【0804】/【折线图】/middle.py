...
sun_color = 'slategrey'
rain_color = 'aqua'
data_edges_color = [sun_color, sun_color, sun_color, sun_color,
                    sun_color, sun_color, sun_color,
                    sun_color, sun_color,
                    sun_color]
data_edges_width = [0.455, 0.281, 0.523, 0.352,
                    0.326, 0.644, 0.361,
                    0.380, 0.182,
                    0.361]
...
#### rain
data_edges_color = [rain_color, rain_color, rain_color, rain_color,
                    rain_color, rain_color, rain_color,
                    rain_color, rain_color,
                    rain_color]
data_edges_width = [0, 0.191, 0, 0,
                    0, 0, 0,
                    0, 0,
                    0]
for index in range(len(data_edges_width)):
...
for index in range(len(data_edges_color)):
   nx.draw_networkx_edges(G, pos, edgelist=data_edges_list[index],
                          edge_color=data_edges_color[index],
                          width = data_edges_width[index],alpha = 0.5)
