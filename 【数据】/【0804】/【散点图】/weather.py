...
ax.scatter(4,78.8831, s=100, marker='x',alpha=0.5)
ax.scatter(1,102.5271, s=100, marker='x',alpha=0.5)

#设置坐标轴文字
ax.set_xlabel('Accident Type', fontsize=15)
ax.set_ylabel('Relative Accident rate (%)', fontsize=15)
#ax.set_title('Crash Involvement Pattern on  Relative Accident Risk', fontsize=15)
#plt.yscale('log')
#设置坐标轴最大最小值
plt.xlim(-1,5)
plt.ylim(75,120)
